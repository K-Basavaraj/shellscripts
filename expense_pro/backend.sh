...
cp /home/ec2-user/practice/shellscripts/expense_pro/backend.service /etc/systemd/system/backend.service
...
mysql -h mysql.basavadevops81s.online -uroot -pExpenseApp@1 < /app/schema/backend.sql &>>$LOG_FILE
